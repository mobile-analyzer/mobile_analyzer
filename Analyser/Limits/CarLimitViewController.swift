...
/// Страница с лимитом на авто
class CarLimitViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        ref.child("users").child(uid!).child("carLimit").observe(.value) { (snap) in
    ...
    @objc func addButtonClicked(_ : UIButton) {
        ...
        let action = UIAlertAction(title: "Set", style: .default) { (action) in
            ...
            self.ref.child("users").child(self.uid!).child("carLimit").setValue(["flag": "true", "limit": limit!, "progress": 0])
    ...
    @objc func deleteButtonClicked(_: UIButton){
        ...
        let deleteAction = UIAlertAction(title: "Delete", style: .default) { (action) in
            ...
            self.forAddButton()
            self.ref.child("users").child(self.uid!).child("carLimit").setValue(["flag": "false", "limit": 0, "progress": 0])
