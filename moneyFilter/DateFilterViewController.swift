...
//            self.cafeExpenseAmount.text = String(Int(value))
//        }
...
//            let value = snapshot.value as! Float
//            self.carExpenseAmount.text = String(Int(value))
//        }
//        //Printing entertainmentExpenseAmount
//        ref.child("users").child(uid!).child("expense").child("Entertainment").child("totalAmount").observeSingleEvent(of: .value) { (snapshot) in
//            let value = snapshot.value as! Float
//            self.entertainmentExpenseAmount.text = String(Int(value))
//        }
...
//            let value = snapshot.value as! Float
//            self.supermarketsExpenseAmount.text = String(Int(value))
//        }
...
//            let value = snapshot.value as! Float
//            self.otherExpenseAmount.text = String(Int(value))
//        }
        
//        let test: Date = Date(timeIntervalSince1970: (1555513809486)/1000)
//        print("to \(test)")
    }
